    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_comment='作成日時')),
                ('updated_at', models.DateTimeField(auto_now=True, db_comment='更新日時')),
                ('company', models.ForeignKey(db_comment='企業ID', on_delete=django.db.models.deletion.CASCADE, related_name='+', to='infrastructure.company')),
                ('parent_category', models.ForeignKey(db_comment='親カテゴリID', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='infrastructure.category')),
            ],
            options={
