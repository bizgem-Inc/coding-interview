# Generated by Django 4.2.5 on 2023-09-05 01:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(db_comment='企業ID', on_delete=django.db.models.deletion.CASCADE, related_name='+', to='Company.company')),
                ('parent_category', models.ForeignKey(db_comment='親カテゴリID', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='Category.category')),
            ],
            options={
